<template>
      ...
      <div class="content">
       ...
       <div class="left-content">
          ...
          <div class="upper-section">
            <div class="section">
              ...
              <div class="text" id="text">
                ...
                <b>闽派建筑</b>，又称福建建筑、闽南建筑，主要分布于福建闽南地区，包括厦门、泉州、漳州等地。闽派建筑风格独特，以<b>红砖白石、雕梁画栋、斗拱雀替</b>等为特色，具有强烈的地域性和文化性。在建筑布局上，闽派建筑讲究风水，注重与自然环境的和谐统一。
              </div>
            </div>
          </div>
        ...
        <div class="lower-section">
          <div class="section">
            <div class="section-title">代表建筑</div>
            <div class="text" id="text" style="text-align: left;">
              ...
              <br>彩绘：青色，蓝色，白色，黄褐
              <br>灯笼，梁柱：深红 -->
              <img src="@/assets/min/06.png" alt="闽派" class="min"> 
            </div>
        ...
        <div class="right-content">
          <div class="image-container">
            <img src="@/assets/small/min.png" alt="图片" class="photo" @click="checkMarker($event)">
  ...
  export default {
    ...
    data() {
      return {
        ...
        markers: [
          { top: 400, left: 1000, info: "整体结构", image: require("@/assets/min/03.jpg") },
          { top: 300, left: 700, info: "剖面图", image: require("@/assets/min/02.jpg") },
          { top: 450, left: 1350, info: "截面图", image: require("@/assets/min/04.jpg") },
      ],
    ...
    methods: {
      ...
      initEcharts() {
        ...
        const option = {
          ...
          color: ['#867e76', '#424c50', '#db5a6b', '#fff'], 
          series: [{
              type: "pie",
              label: {
                show: true,
    ...
    .container {
      ...
      background-color: rgba(188, 125, 62, 0.4);
    ...
    .content {
      ...
      background: linear-gradient(to bottom, rgba(209,173,137,0), rgba(147, 110, 73, 0.8)); /* 使用渐变色作为背景，从上到下 */
  ...
  @keyframes ripple {
    0% {
      transform: scale(1);
      opacity: 0.7;
      background-color:rgb(207, 163, 122);
    }
    50% {
      transform: scale(2);
      opacity: 0.3;
      background-color:rgb(180, 146, 114);
    }
    100% {
      transform: scale(3);
      opacity: 0.1;
    ...
    .upper-section{
      height: 30%;    
      background-color: rgba(180, 141, 91, 0.4);
    ...
    .upper-section:hover{
      background-color: rgba(168, 125, 84, 0.5);
      height: 30%; 
      line-height: 24px;
    }
    .lower-section {
      ...
      background-repeat: no-repeat; /* 防止背景图片重复 */
      background-position: center; /* 将背景图片居中 */
      background-color: rgba(190, 145, 104, 0.3);
      margin-bottom: 10px;
      border-radius: 42px;
      overflow: scroll;
    ...
    .lower-section:hover {
      line-height: 28px;
      background-color: rgba(156, 122, 58, 0.5);
