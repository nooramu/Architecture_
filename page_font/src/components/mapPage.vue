<template>
    <div class="container">
        <section v-show="selectedProvince!=null" class="left">
            ...
            getState().then(()=>{
                ...
                mychart.on('click', (params) => {
                    ...
                    if (params.componentType === 'series') {
                        ...
                        switch(provinceName) {
                            case '晋派建筑':
                                selectedProvince.value  = 'shanxi';
                                break;
                            case '京派建筑':
                                selectedProvince.value  = 'beijing';
                                break;
                            case '川派建筑':
                                selectedProvince.value  = 'sichuan';
                                break;
                            case '苏派建筑':
                                selectedProvince.value  = 'jiangsu';
                                break;
                            case '海派建筑':
                                selectedProvince.value  = 'shanghai';
                                break;
                            case '徽派建筑':
                                selectedProvince.value  = 'anhui';
                                break;
                            case '粤派建筑':
                                selectedProvince.value  = 'guangdong';
                                break;
                            case '闽派建筑':
                                selectedProvince.value  = 'fujian';
                                break;
                            default:
                ...
                async function loadProvinceInfo(provinceName) {
                    ...
                    try { 
                        response = await axios.get(`http://localhost:8080/map/province/${provinceName}.json`);
...
.container{
    ...
    height: 90vh;    /* background-color: gray; */
    display: flex;
    width: 100%; /* 容器宽度100% */
}
.map{
